...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.cdr.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.cdrs.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label for="calldate">{{ trans('cruds.cdr.fields.calldate') }}</label>
                <input class="form-control datetime {{ $errors->has('calldate') ? 'is-invalid' : '' }}" type="text" name="calldate" id="calldate" value="{{ old('calldate') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('clid') ? 'is-invalid' : '' }}" type="text" name="clid" id="clid" value="{{ old('clid', '') }}">
                @if($errors->has('clid'))
                    <div class="invalid-feedback">
                        {{ $errors->first('clid') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dst') ? 'is-invalid' : '' }}" type="text" name="dst" id="dst" value="{{ old('dst', '') }}">
                @if($errors->has('dst'))
                    <div class="invalid-feedback">
                        {{ $errors->first('dst') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dcontext') ? 'is-invalid' : '' }}" type="text" name="dcontext" id="dcontext" value="{{ old('dcontext', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dstchannel') ? 'is-invalid' : '' }}" type="text" name="dstchannel" id="dstchannel" value="{{ old('dstchannel', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('lastapp') ? 'is-invalid' : '' }}" type="text" name="lastapp" id="lastapp" value="{{ old('lastapp', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('lastdata') ? 'is-invalid' : '' }}" type="text" name="lastdata" id="lastdata" value="{{ old('lastdata', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('billsec') ? 'is-invalid' : '' }}" type="number" name="billsec" id="billsec" value="{{ old('billsec', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('disposition') ? 'is-invalid' : '' }}" type="text" name="disposition" id="disposition" value="{{ old('disposition', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('amaflags') ? 'is-invalid' : '' }}" type="number" name="amaflags" id="amaflags" value="{{ old('amaflags', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('accountcode') ? 'is-invalid' : '' }}" type="text" name="accountcode" id="accountcode" value="{{ old('accountcode', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('uniqueid') ? 'is-invalid' : '' }}" type="text" name="uniqueid" id="uniqueid" value="{{ old('uniqueid', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('userfield') ? 'is-invalid' : '' }}" type="text" name="userfield" id="userfield" value="{{ old('userfield', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('peeraccount') ? 'is-invalid' : '' }}" type="text" name="peeraccount" id="peeraccount" value="{{ old('peeraccount', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('linkedid') ? 'is-invalid' : '' }}" type="text" name="linkedid" id="linkedid" value="{{ old('linkedid', '') }}">
